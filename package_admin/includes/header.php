...
<?php
$a=$_SESSION['panel_user'];
?>
    <body>
<div class="header-main">
					<div class="logo-w3-agile" style="background-color:orange;">
								<h1><a href="dashboard.php" style="background-color:orange;"><?php echo $_SESSION['panel_user']; ?></a></h1>
							</div>
						<div class="profile_details w3l" style="background-color:white; border:1px solid black;">		
								<ul>
									<li class="dropdown profile_details_drop" >
										...
										<?php
										$sql="select * from admin_panel where agency_name='$a'";
										$r=mysqli_query($con,$sql);
										while($a=mysqli_fetch_array($r))
									{ 
										?>
										<div class="profile_img">	
												<span class="prfil-img" style="border:1px solid black; border-radius:50%;"><img src="../login/images/<?php echo $a[6];?>" alt=""> </span> 
												<div class="user-name">
