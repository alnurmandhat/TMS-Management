...
$sql2="select *from booking where status='cancel'";
...
<div class="agile-grids">	
            ...
            <form action="form2.php">
              ...
              <th  style="background-color:#ED5C14;">Email</th>
							...
							<th  style="background-color:#ED5C14;" >AGENCY NAME</th>
...
{ ?>
  <tr>
      ...
      <td><?php echo $sql3[10];?></td>
         ...
         <td> <a href="admin_cancel_booking.php ?id=<?php echo $sql3[0]; ?>"><button class="btn btn-success" style="width:100px">Activate</button></a>
          </td>
