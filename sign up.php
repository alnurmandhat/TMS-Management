...
<body>
    <div class="login-page">
      <div class="form">
        ...
        <!-- <form class="login-form"onsubmit="return validate123()" method="post" action="home.php">
            <input type="text" name="n" id="fname1" placeholder="Enter name">
            <p id="fn1"></p>
          <input type="email" name="e" id="emailid1" placeholder="Enter email">
          <p id="mail1"></p>
          <input type="text" name="m"id="mobile1" placeholder="Enter mobile number">
          <p id="mno"> </p>
          <input type="password" name="pwd" id="pass" placeholder="Enter password">
          <p id="passw"></p>
          <input type="submit" value="sign in" name="btn" class="login-btn">
          <p class="message">Do you want to sign up? <a href="sign_up.php">sign up here</a></p>
        </form> -->

        <form onSubmit="return(validate123());" method="post" action="" enctype="multipart/form-data">
<input type="text" class="form-control" placeholder="Enter Name" id="fname1" name="fn1" required>
<p id="fn1"></p>
...
{ 
    ...
    $sql= "insert into users values('','$n','$em','$p','$pn','$pf','$t','','Inactive')";
