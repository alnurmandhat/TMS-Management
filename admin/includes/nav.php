...
<body>
   <div class="sidebar">
     ...
     <ul class="nav_list">
      ...
      <li>
        <a href="manage_isuue.php">
         <i class='bx bx-folder'></i>
         <span class="links_name"> Manager issues</span>
        </a>
        <span class="tooltip">Manager issues</span>
      </li>
      <li>
        <a href="manage_inq.php">
         <i class='bx bx-cart-alt'></i>
         <span class="links_name">Manage inquiries</span>
        </a>
        <span class="tooltip">Manage inquiries</span>
      </li>
      <!-- <li> -->
        <!-- <a href="#">
