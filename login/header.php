...
<div class="top">
    <div class="top-navbar" >
        ...
        <a href="issue-tickets.php">Issue tickets</a>
        </div>
</div>
    <div class="top-navbar" style="margin-right:-90.0rem;">
    <!-- <a href="home.php" style="margin-right:-0.0rem;">sign out</a> -->
    </div>
    <div class="icons"></div>
    </div>
<header>
    ...
    <nav class="navbar">
        ...
        <a href="write.php"class="<?php if(basename($_SERVER['PHP_SELF'])=="write.php")
                                         {
                                            echo "active";
                                         }?>">need help? / write us</a>
    </nav>

    
    <div class="icons">
        <i class="fas fa-search" id="search-btn"></i>
        <a href="logout.php" style="margin-right:-0.0rem; color:#fff;
  font-size: 2rem;
  margin:0 .8rem;">sign out</a> 
    </div>
